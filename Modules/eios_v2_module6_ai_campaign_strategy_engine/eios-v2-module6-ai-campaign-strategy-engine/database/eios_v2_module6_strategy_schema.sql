...
SELECT target_area, target_segment, persuasion_priority, SUM(estimated_votes) estimated_votes, AVG(persuasion_score) avg_score
FROM persuasion_targets
GROUP BY target_area, target_segment, persuasion_priority;