...
async function runProductionImport() {
    ...
    if (
        ...
        throw new Error(
            'Production import requires the confirmation token "COMMIT-PSGC-2026-Q2".'
        );
    }
...
console.log(
    ...
    console.log(
        "\n[5/5] Running production database import..."
    );
    ...
    console.log(
        "\nProduction import committed successfully."
    );
}

runProductionImport().catch(
    (error) => {
        console.error(
            "\nPSGC PRODUCTION IMPORT FAILED:"
        );
