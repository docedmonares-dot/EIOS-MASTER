...
const electionPositions = [
    { code: "PRESIDENT", name: "President", level: "NATIONAL", group: ["PRESIDENT_VICE_PRESIDENT", "President and Vice President"], candidates: 6, maxSelections: 1 },
    { code: "VICE_PRESIDENT", name: "Vice President", level: "NATIONAL", group: ["PRESIDENT_VICE_PRESIDENT", "President and Vice President"], candidates: 6, maxSelections: 1 },
    { code: "SENATOR", name: "Senator", level: "NATIONAL", group: ["SENATORS", "Senators"], candidates: 25, maxSelections: 12 },
    { code: "PARTY_LIST_REP", name: "Party-list Representative", level: "NATIONAL", group: ["PARTY_LIST", "Party-list"], candidates: 6, maxSelections: 1 },
    { code: "GOVERNOR", name: "Governor", level: "PROVINCIAL", group: ["PROVINCIAL_OFFICIALS", "Governor, Vice Governor, and Board Members"], candidates: 6, maxSelections: 1 },
    { code: "VICE_GOVERNOR", name: "Vice Governor", level: "PROVINCIAL", group: ["PROVINCIAL_OFFICIALS", "Governor, Vice Governor, and Board Members"], candidates: 6, maxSelections: 1 },
    { code: "BOARD_MEMBER", name: "Provincial Board Member", level: "PROVINCIAL", group: ["PROVINCIAL_OFFICIALS", "Governor, Vice Governor, and Board Members"], candidates: 8, maxSelections: 5, districtConfigurable: true },
    { code: "DISTRICT_REP", name: "District Representative", level: "PROVINCIAL", group: ["DISTRICT_REPRESENTATIVE", "Congressman or District Representative"], candidates: 6, maxSelections: 1, districtConfigurable: true },
    { code: "MAYOR", name: "Municipal Mayor", level: "MUNICIPALITY_CITY", group: ["CITY_MUNICIPAL_OFFICIALS", "Mayor, Vice Mayor, and Councilors"], candidates: 6, maxSelections: 1 },
    { code: "VICE_MAYOR", name: "Municipal Vice Mayor", level: "MUNICIPALITY_CITY", group: ["CITY_MUNICIPAL_OFFICIALS", "Mayor, Vice Mayor, and Councilors"], candidates: 6, maxSelections: 1 },
    { code: "COUNCILOR", name: "Municipal Councilor", level: "MUNICIPALITY_CITY", group: ["CITY_MUNICIPAL_OFFICIALS", "Mayor, Vice Mayor, and Councilors"], candidates: 15, maxSelections: 8, districtConfigurable: true },
    { code: "BARANGAY_CAPTAIN", name: "Punong Barangay", level: "BARANGAY", group: ["BARANGAY_OFFICIALS", "Punong Barangay and Barangay Councilors"], candidates: 6, maxSelections: 1 },
    { code: "BARANGAY_COUNCIL", name: "Barangay Councilor", level: "BARANGAY", group: ["BARANGAY_OFFICIALS", "Punong Barangay and Barangay Councilors"], candidates: 10, maxSelections: 7 },
];
        ...
        questions: electionPositions.map((position) => ({
            ...
            settings: {
                election_position: {
                    ...
                    electoral_group_code: position.group[0],
                    electoral_group_name: position.group[1],
                    electoral_group_is_applicable: true,
                    is_applicable: true,
